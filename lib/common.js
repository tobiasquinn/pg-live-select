...
module.exports = exports = {
  ...
  */
	getQueryDetails: function getQueryDetails(client, query, params) {
		var nullifiedQuery, viewName, tablesResult, isUpdatableResult, explainResult, parsedTriggers;
		return _regeneratorRuntime.async(function getQueryDetails$(context$1$0) {
			while (1) switch (context$1$0.prev = context$1$0.next) {
				...
				case 12:
					context$1$0.next = 14;
					return exports.performQuery(client, "EXPLAIN (FORMAT JSON) " + query, params);

				case 14:
					explainResult = context$1$0.sent;
					parsedTriggers = parseExplainResult(explainResult.rows[0]["QUERY PLAN"][0].Plan);
